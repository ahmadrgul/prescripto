        ...
        <div className="w-[570px] border border-[#D4D4D4] py-14 px-12 rounded-2xl">
            ...
            <form className="my-10 flex flex-col gap-4">
                <div className="flex flex-col gap-2">
                    ...
                    <input type="email" id="email" className="border-[#DADADA] border h-14 w-full rounded-lg"/>
                </div>
                <div className="flex flex-col gap-2">
                    <label htmlFor="password" className="text-[#4B5563] text-xl">Password</label>
                    <input type="password" id="password" className="border-[#DADADA] border h-14 w-full rounded-lg"/>
                </div>
                <input type="submit" value="Login" className="bg-primary text-gray-100 text-xl font-medium h-14 w-full rounded-lg mt-4" />
            </form>
            <p className="text-xl text-[#4B5563]">Don't have an account? <a href="/login" className="underline text-primary">Register Here</a></p>
        </div>
    </main>
  )
}
