...
const Contact = () => {
  return (
    <main>
      <h1 className="text-center text-[#4B5563] font-semibold text-3xl mb-20">
      ...
      <div className="flex flex-col items-center md:flex-row md:justify-center gap-20">
        ...
        <div className="font-outfit w-1/2 text-[#4B5563] flex flex-col justify-center">
          ...
          <button className="mt-10 w-fit px-6 py-4 hover:bg-primary hover:border-transparent hover:text-gray-100 border-[#4B5563] border">
            Explore Jobs
          </button>
        </div>
      </div>
