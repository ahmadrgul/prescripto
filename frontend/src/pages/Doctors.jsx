        ...
        <div className="flex gap-10 mb-20">
            ...
            {   
                ...
                <div className="flex items-center justify-center">
                    <ErrorComponent 
                        title={"Unable to load specializations: " + errorSpecs?.response?.data?.errors[0]?.code || errorSpecs.message}
                        retry={refetchSpecs}
                    />
                </div> :
                loadingSpecs ?
            ...
            {   
                ...
                <div className="flex items-center justify-center">
                    <ErrorComponent 
                        title={"Unable to load doctors data: " + errorDoctors?.response?.data?.errors[0]?.code || errorDoctors.message}
