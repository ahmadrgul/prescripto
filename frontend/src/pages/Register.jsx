...
const Register = () => {
  ...
  const mutation = useMutation({
    ...
    onSuccess: (data) => {
      toast.success(
        `Thanks for registrating, ${data.first_name}. You can login now`,
      );
      navigate("/login");
    },
      ...
      <div className="w-[570px] border border-[#D4D4D4] py-14 px-12 rounded-2xl">
        ...
        >
          <div className="flex flex-col gap-2">
            <label htmlFor="firstname" className="text-[#4B5563] text-xl">
              Firstname
            </label>
            <input
              autoFocus
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="email" className="text-[#4B5563] text-xl">
              Email
            </label>
            <input
              type="email"
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="password" className="text-[#4B5563] text-xl">
              Password
            </label>
            <input
              type="password"
